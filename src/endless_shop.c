...
Uint64 endlessStripWorstMod(Uint64 mods)
{
	...
	static const Uint64 order[] = {  // nastiest first
		ENDLESS_MOD_LEGION, ENDLESS_MOD_APEX, ENDLESS_MOD_KILLSHOT, ENDLESS_MOD_DEADGEN,
		ENDLESS_MOD_RAMPAGE, ENDLESS_MOD_OVERLOAD, ENDLESS_MOD_TRUEAIM,
		ENDLESS_MOD_WARP,  // ranked immediately below Overload
		ENDLESS_MOD_HUNTER, ENDLESS_MOD_ELITEPACK,
		ENDLESS_MOD_BURNOUT, ENDLESS_MOD_MARTYRDOM,  // highest-weight kill-triggered dangers
		ENDLESS_MOD_TWINSEEK,
...
void endlessBetweenLevels(void)
{
	...
	// A locked reopen has already restored the outpost episode.
	endlessSortieOutpostEp = (JE_byte)JE_currentEpisodeId();
