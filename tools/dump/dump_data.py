...
Generated by `tools/dump/dump_data.py` from a %(release)s data directory. Every
file in it is represented here. Sprites and tiles are coloured with palette %(palette)d
